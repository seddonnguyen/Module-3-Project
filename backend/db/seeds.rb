...
Comment.create(post: dog_boarding_kennel, comment: "You can find more details at http://murphycreekpetresort.com/")
...
Comment.create(post: bike_for_sale, comment: "What is your email address?")
Comment.create(post: bike_for_sale, comment: "bob@gmail.com")
Comment.create(post: bike_for_sale, comment: "Is this available for delivery?")
...
Comment.create(post: sofa_for_sale, comment: 'Can I drop by to take a look at it?')
Comment.create(post: sofa_for_sale, comment: 'Yes. Call me at 720-333-9923')